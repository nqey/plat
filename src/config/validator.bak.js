 ...
 * 示例：
  项目
  <input type="text" class="v-validator" v-validator="validator.item">
  项目
  <button type="button" class="btn btn-primary" v-validator-submit>提交</button>
  //验证组
  validator: {
    item: {
      type: ['required', 'maxLength'], //必须
      // 最大长度验证 可选
      maxLength: 2,
      // 最小长度验证 可选
      minLength: 1,
