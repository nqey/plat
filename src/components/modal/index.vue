      ...
      <div class="modal-dialog" role="document" :style="{ width: mystyle.width }">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" @click="toggle"><span aria-hidden="true">×</span></button>
          ...
          <div class="modal-footer">
            <slot name='footer'>
              <button slot="footer" type="button" class="btn btn-primary" @click="commit">确认</button>
