            ...
            <ul>
              <li>
                <input class="input valid" name="username" type="text" placeholder="用户名" title="用户名" v-model="username"
                       val-required no-validate-pass-tip @keypress.enter="login">
              </li>
              <li>
                <input class="input valid" name="password" type="password" placeholder="密码" title="密码" val-required
                       v-model="password" no-validate-pass-tip @keypress.enter="login">
              </li>
              <li>
                <ul class="logo_yzm">
                  <li>
                  ...
                  <li class="verifycode-wrapper txr"><img :src="yzx" alt="点击更换验证码" width="112" height="45" @click="yzm">
                  </li>
                </ul>
              </li>
            </ul>
...
<script>
  ...
  import { CHECKNUMBER, DOMAIN, PLATFORM_LOGIN_DO_ADDRESS } from '@/config/env';
