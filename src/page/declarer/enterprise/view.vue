  ...
  <div class="plat-content">
    <div class="plat-content-con">
      ...
      <v-modal
        ...
        <div slot="body">
          <div class="form-group">
            <textarea class="form-control" placeholder="请输入不通过原因" style="height: 200px;" val-required
                      v-model="reason" no-validate-pass-tip autofocus></textarea>
          </div>
        </div>
      </v-modal>
    </div>
