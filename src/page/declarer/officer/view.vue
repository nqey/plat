    ...
    <div class="plat-content-con">
      ...
      <form class="form-horizontal">
        <div class="form-group">
          <label class="col-sm-offset-3 col-sm-1 control-label txr">寸照</label>
          <div class="col-sm-8">
        ...
        <div class="form-group">
          <label class="col-sm-offset-3 col-sm-1 control-label txr">姓名</label>
          <div class="col-sm-8">
...
import modal from '@/page/declarer/officer/modal';
  ...
  methods: {
    ...
    async submit(state) {
      ...
      if (status !== 'pass') {
        ...
        if (res.success) {
          this.$router.push('/declarer/officer');
        } else {
          this.isShowSubmit = !this.isShowSubmit;
        }
      }
